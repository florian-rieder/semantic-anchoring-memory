...
class Memory():
    ...
    def save_memory(memory: str) -> None:
        ...
        self.db.add_texts([memory], [metadata])

    def create_query(chat_message_history: str, llm: BaseLanguageModel):
        chain = LLMChain(prompt=QUERY_CREATION_PROMPT, llm=llm)
        result = chain.predict(input=chat_message_history)
        return result
...
if __name__ == '__main__':
    ...
    memory = Memory(embeddings_model)
